...
import { FaEnvelope, FaLinkedin, FaGithub, FaWhatsapp, FaPhoneAlt } from 'react-icons/fa';
  ...
  return (
    <section id="contact" className="py-24 px-6 max-w-5xl mx-auto text-center text-white">
      ...
      <div className="grid grid-cols-2 md:grid-cols-4 gap-8">
        <a href="mailto:tanjilapatwaryy@gmail.com" className="p-8 bg-[#111827] border border-zinc-800 rounded-2xl hover:border-[#4f46e5] transition group">
        ...
        <a href="tel:+8801872249768" className="p-8 bg-[#111827] border border-zinc-800 rounded-2xl hover:border-[#4f46e5] transition group">
          <FaPhoneAlt className="text-3xl mx-auto mb-4 text-[#22c55e] group-hover:scale-110 transition" />
          <h4 className="font-bold">Phone</h4>
          <p className="text-zinc-500 text-sm">01872249768</p>
        </a>
